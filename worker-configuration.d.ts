/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5dc8bb3258fe1a64a416c4553daf2ca6)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 
interface __BaseEnv_Env {
	DB: D1Database;
	SEND_CODE_GLOBAL: RateLimit;
	ASSETS: Fetcher;
	APP_DATA_KEY: string;
	TIANJI_DES_KEY: string;
	TIANJI_DES_IV: string;
	TIANJI_USER_ORIGIN: string;
	TIANJI_IOT_ORIGIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_DATA_KEY" | "TIANJI_DES_KEY" | "TIANJI_DES_IV" | "TIANJI_USER_ORIGIN" | "TIANJI_IOT_ORIGIN" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
